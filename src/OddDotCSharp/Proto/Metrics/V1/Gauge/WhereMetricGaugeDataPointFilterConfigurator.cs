...
{
    /// <summary>
    /// Configurator for properties specific to the DataPoint property
    /// of a Metric Gauge.
    /// </summary>
    public class WhereMetricGaugeDataPointFilterConfigurator
    {
        ...
        internal WhereMetricGaugeDataPointFilterConfigurator(WhereMetricFilterConfigurator configurator)
        {
