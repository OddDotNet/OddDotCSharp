...
{
    /// <summary>
    /// Configurator for properties specific to a SpanLink of a Span.
    /// </summary>
    public class WhereSpanLinkFilterConfigurator
    {
        ...
        internal WhereSpanLinkFilterConfigurator(WhereSpanFilterConfigurator configurator)
        {
            ...
            Action<ArrayValueFilterConfigurator> configure)
        {
            ...
            filter.Property.Link.Attributes.Values[0].Value.ArrayValue.Values.AddRange(_arrayValueFilterConfigurator.Properties);
            _configurator.Filters.Add(filter);
            return _configurator;
        }
            ...
            Action<KeyValueListFilterConfigurator> configure)
        {
            ...
            filter.Property.Link.Attributes.Values[0].Value.KvlistValue.Values.AddRange(_keyValueListFilterConfigurator.Properties);
            _configurator.Filters.Add(filter);
            return _configurator;
        }
