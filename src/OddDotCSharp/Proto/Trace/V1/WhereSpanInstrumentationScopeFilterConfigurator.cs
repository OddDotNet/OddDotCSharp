...
{
    /// <summary>
    /// Configurator for properties specific to the InstrumentationScope of a Span.
    /// </summary>
    public class WhereSpanInstrumentationScopeFilterConfigurator
    {
        ...
        internal WhereSpanInstrumentationScopeFilterConfigurator(WhereSpanFilterConfigurator configurator)
        {
